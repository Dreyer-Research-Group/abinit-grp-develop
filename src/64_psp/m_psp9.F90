...
!!
!! SOURCE
! CEDrev: new variable for 3rd derivative
subroutine psp9in(filpsp,ekb,epsatm,ffspl,ffspl1,indlmn,lloc,lmax,lmnmax,lnmax,&
...
! CEDrev: pass ffspl1
   call psp8nl(amesh,ffspl,ffspl1,indlmn,lmax,lmnmax,lnmax,mmax,&
